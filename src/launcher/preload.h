...
const char * const libs[] = { "/usr/lib/libmeegotouchcore.so.0",
                              ...
                              "/usr/lib/libgallery-widgets.so.1.0.0",
                              "/usr/lib/libgallerycore.so.1.0.0",
                              "/usr/lib/libgconf-2.so.4.1.0",
                              "/usr/lib/libgeoengine-mapwidget.so.1.0.0",
                              "/usr/lib/libgeoengine.so.1.0.0",
                              ...
                              "/usr/lib/libthumbnailer.so.0.1.5",
